...
public class ImproveDiscoveryClusterData {
	...
	public ImproveDiscoveryClusterData(XLog log)  {
		// TODO Auto-generated constructor stub
		this.mainLog=log;      
	}
	
	public void GetNumberOfCase()
	{
	...
	private void encodeLog() {
			...
			try {
				...
				//Todas las actividades codificadas ->listas para saber el numero máximo de cluster q puedo hacer.
				for(int j=0;j<encodeTraces.getCharStreamList().size();j++)
					System.out.print("\n"+encodeTraces.getCharStreamList().get(j));
