...
public class ImproveDiscoveryParametersPanel extends JPanel {
	...
	public ImproveDiscoveryParametersPanel(ImproveDiscoveryTransformation Transformation,ActionListener SocialAction, ActionListener ClusterAction, ActionListener PerformanceAction) {
