...
/**
 * Methods to get clusters ( Trace Align subset)
*/
public class OLAPClusterTransformation {

	private IndelSubstitutionMatrix indelSubstitutionMatrix;
	private 	AgglomerativeHierarchicalClustering ahc;
	...
	public OLAPClusterTransformation(ClusterData ClusterData) {
...
public void Step3()
{
   ...
   //Distance by default	if (isDistanceSelected) 
	...
	indelSubstitutionMatrix = new IndelSubstitutionMatrix(encodingLength,ClusterData.GetEncodeTraceList());
