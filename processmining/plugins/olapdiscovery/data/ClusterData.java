...
/**
 * The data repository of Cluster Transformations
*/
public class ClusterData {
	...
	public ClusterData(XLog log,int numberClusters)  {
		// TODO Auto-generated constructor stub
		this.mainLog=log;      
		this.numberClusters=numberClusters;
	}
		
	public void SetMainLog(XLog log)
	{
		this.mainLog=log;
	}
	...
	{
		System.out.print("clusters:"+newNumber);
