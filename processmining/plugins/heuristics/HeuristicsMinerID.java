package org.processmining.plugins.PromMasterPlugin.processmining.plugins.heuristics;
...
public class HeuristicsMinerID {
	...
	public HeuristicsMinerID(PluginContext context,XLog log) {
	...
	public HeuristicsMinerID(PluginContext context,XLog log, XLogInfo logInfo) {
	...
	public HeuristicsMinerID(PluginContext context, XLog log, XLogInfo logInfo, HeuristicsMinerSettings settings) {

		this(context, log, logInfo);
		this.settings = settings;
	}

	public HeuristicsMinerID(PluginContext context, XLog log, HeuristicsMinerSettings settings) {
